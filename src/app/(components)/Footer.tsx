...
function Footer() {
  return (
    <footer className="bg-white py-10">
      <div className="max-w-[1000px] m-auto w-[90%]">
        <div className="items flex gap-10 justify-between flex-wrap items-start">
          <div className="item-1">
            ...
            <p className="max-w-sm text-justify hyphens-auto mt-5">Bizniz Global Advisory Services – Your trusted partner in accounting, auditing, taxation, and business consulting. Empowering businesses with expert strategies for sustainable growth. Let's build success together!</p>
        ...
        <div className="item-2">
          ...
          <div className="item-3">
            ...
            <ul className="pt-4 flex flex-col max-w-sm gap-2">
        ...
        <div className="colab my-10 flex gap-5 flex-col">
          <div className="cards flex flex-wrap justify-center items-center gap-5">
            <div className="card bg-gray-300/50 h-10 w-24 rounded-lg"></div>
            <div className="card bg-gray-300/50 h-10 w-32 rounded-lg"></div>
            <div className="card bg-gray-300/50 h-10 w-44 rounded-lg"></div>
          </div>

          <div className="cards flex flex-wrap justify-center items-center gap-5">
            <div className="card bg-gray-300/50 h-10 w-44 rounded-lg"></div>
            <div className="card bg-gray-300/50 h-10 w-52 rounded-lg"></div>
            <div className="card bg-gray-300/50 h-10 w-32 rounded-lg"></div>
          </div>
